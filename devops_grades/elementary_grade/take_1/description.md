...
Рекомендуемый материал перед выполнением задачи:
 ...
 - *[контроль версий git. Создаем коммиты и как делать историю изменений проекта понятнее и организованнее](https://github.com/exzvor/freedevopsworkspace/blob/feat/main/tech/git/commit.md)*
